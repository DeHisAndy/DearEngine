...
{
public:
	static void RHI_DrawMatrialToRenderTarget(ID3D11RenderTargetView* ppRenderTargetViews, const FString& matrial,const FString& texture2D, class UPrimitiveComponent* mesh);
