    ...
    if (ImGui::TreeNode("Text Input"))
    {
        ...
        if (ImGui::TreeNode("Filtered Text Input"))
        {
            struct TextFilters
            {
                ...
                {
                    if (data->EvenWCHAR < 256 && strchr("imgui", (char)data->EvenWCHAR))
                        return 0;
                    return 1;
                }
            };
        ...
        if (ImGui::TreeNode("Completion, History, Edit Callbacks"))
        {
            struct Funcs
            {
                static int MyCallback(ImGuiInputTextCallbackData* data)
                {
                    ...
                    {
                        data->InserWCHARs(data->CursorPos, "..");
                    }
                    else if (data->EventFlag == ImGuiInputTextFlags_CallbackHistory)
                    {
                        if (data->EventKey == ImGuiKey_UpArrow)
                        {
                            ...
                            data->InserWCHARs(0, "Pressed Up!");
                            data->SelectAll();
                        }
                        else if (data->EventKey == ImGuiKey_DownArrow)
                        {
                            data->DeleteChars(0, data->BufTextLen);
                            data->InserWCHARs(0, "Pressed Down!");
                            data->SelectAll();
                        }
                    }
        ...
        case ImGuiInputTextFlags_CallbackCompletion:
            {
                ...
                else if (candidates.Size == 1)
                {
                    ...
                    data->InserWCHARs(data->CursorPos, candidates[0]);
                    data->InserWCHARs(data->CursorPos, " ");
                }
                else
                {
                    ...
                    {
                        data->DeleteChars((int)(word_start - data->Buf), (int)(word_end - word_start));
                        data->InserWCHARs(data->CursorPos, candidates[0], candidates[0] + match_len);
                    }
        ...
        case ImGuiInputTextFlags_CallbackHistory:
            {
                ...
                if (prev_history_pos != HistoryPos)
                {
                    ...
                    data->DeleteChars(0, data->BufTextLen);
                    data->InserWCHARs(0, history_str);
                }
            }
        }
        return 0;
